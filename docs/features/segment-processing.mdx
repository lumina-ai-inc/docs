...
If you need extended context for LLM processing, you must explicitly enable it by setting `use_extended_context=True` in your `GenerationConfig`. Extended context requires a page image to be available at runtime.
