...
```python
# Create task immediately
task = await chunkr.create_task("path/to/your/file.pdf")
...
# From a base64 string (must include MIME type header)
task = chunkr.upload("data:application/pdf;base64,JVBERi0...")
