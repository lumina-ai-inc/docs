...
The output response is the structured JSON data resulting from processing the file. It follows the schema defined in the [Structured Extraction](/structured_extraction.mdx) and [Chunks](/chunks.mdx) sections. Below is an example of the output response:
