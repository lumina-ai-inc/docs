...
2. **Create a task**
   ...
   ```bash
    curl -X POST https://api.chunkr.com/api/v1/task \
...
3. **Get the task**
   ...
   ```bash
   curl -X GET https://api.chunkr.com/api/v1/task/${TASK_ID} \
     -H "Authorization: ${YOUR_API_KEY}"
   ```
...
4. **Interpreting the Response**
   ...
   Here is an example of what the output might look like, for a full list of fields and explanation of the output, refer to the [task response](/task-response) page.
    ...
    "input_file_url": "https://storage.chunkr.com/input/document.pdf",
    ...
    "task_url": "https://api.chunkr.com/api/v1/task/65237fe1-d6f1-456b-9238-408b97a1536d"
    }
    ```